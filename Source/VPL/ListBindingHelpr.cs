//This is Google's cache of http://www.wikiencyclopedia.net/net/DotNET/DotNET/8.0/untmp/whidbey/REDBITS/ndp/fx/src/WinForms/Managed/System/WinForms/ListBindingHelper.cs/1/ListBindingHelper.cs. It is a snapshot of the page as it appeared on Jul 30, 2011 10:34:47 GMT. The current page could have changed in the meantime. Learn more

//Text-only versionThese search terms are highlighted: itypedlist example listbindinghelper  
//------------------------------------------------------------------------------ 
...
namespace System.Windows.Forms { 
    ...
    public static class ListBindingHelper {
        ...
        public static object GetList(object dataSource, string dataMember) {
            ...
            if (dmProp == null) { 
                throw new System.ArgumentException(string.Format(CultureInfo.CurrentUICulture,Resource1.DataSourceDataMemberPropNotFound, dataMember)));
            } 
        ...
        private static PropertyDescriptorCollection GetListItemPropertiesByInstance(object target, PropertyDescriptor[] listAccessors, int startIndex) { 
            ...
            if (listAccessors != null && listAccessors.Length > startIndex) { 
                ...
                if (value == null) {
                    ...
                    pdc = GetListItemPropertiesByType(listAccessors[startIndex].PropertyType);
                } 
                else {
