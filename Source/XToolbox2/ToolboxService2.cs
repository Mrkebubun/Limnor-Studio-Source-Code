...
namespace XToolbox2
{
	...
	/// toolbox control.
	public class ToolboxService2 : System.Drawing.Design.IToolboxService
	{
        private IDesignerHost host;
        private ToolboxPane2 toolbox;

		public ToolboxService2(IDesignerHost host)
		{
            this.host = host;

			// Our MainForm adds our ToolboxPane to the host's services.
            toolbox = host.GetService(typeof(ToolboxPane2)) as ToolboxPane2;
		}
		...
		{
			//if (toolbox.SelectedTool.DisplayName != "<Pointer>") // <Pointer> is not a tool.
            if (toolbox.SelectedItem != null && toolbox.SelectedItem.TypeName != null )
			{
