...
namespace LimnorDesigner
{
    ...
    /// a variable
    /// </summary>
    [MathNodeCategory(enumOperatorCategory.Other)]
    [Description("a variable")]
    [ToolboxBitmap(typeof(MathNodeVar), "Resources.MathNodeVariable.bmp")]
    public class MathNodeVar : MathNode
    {
        ...
        public DataTypePointer VariableType
        {
            get
            {
                if (_dataType == null)
                {
                    _dataType = new DataTypePointer(new TypePointer(typeof(double)));
                }
                return _dataType;
            }
            set
        ...
        public override object CloneExp(MathNode parent)
        {
            ...
            node.VariableType = (DataTypePointer)VariableType.Clone();
            return node;
        }
