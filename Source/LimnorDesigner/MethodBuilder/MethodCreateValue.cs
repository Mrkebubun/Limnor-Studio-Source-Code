...
namespace LimnorDesigner.MethodBuilder
{
	...
	/// </summary>
	class MethodCreateValue : IMethod, IObjectPointer, IActionMethodPointer
	{
		private ActionAssignInstance _action;
		private ParameterClass _returnType;
		public MethodCreateValue(ActionAssignInstance act)
		{
			_action = act;
		}
		...
		public ClassPointer RootPointer
		{
			...
			{
				if (_action != null)
					return _action.ActionOwner.RootPointer;
				return null;
			}
		}
		[Browsable(false)]
		...
		{
			get { return string.Format(CultureInfo.InvariantCulture, "cv_{0}.{1}", Owner.ObjectKey, MethodSignature); }
		}
		...
		public IAction Action
		{
			...
			set
			{
				_action = (ActionAssignInstance)value;
			}
		}
