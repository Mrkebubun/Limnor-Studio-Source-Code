...
namespace LimnorDesigner.Action
{
	...
	/// </summary>
	[UseParentObject]
	public class ActionAssignInstance : IAction, ICustomTypeDescriptor, ITypeScopeHolder, IScopeMethodHolder
	{
		#region fields and constructors
		public const string Instance_Type = "InstanceType";
		public const string Instance_Value = "InstanceValue";
		private const UInt32 IntanceTypeId = 1878669642;
		private const UInt32 IntanceValueId = 2522910249;
		private LocalVariable _var; //the variable to receive the value, identified by its member id, _varId
		...
		//
		private MethodCreateValue _actMethod;
		...
		public string VariableName
		{
			get
			{
				if (_var == null)
					return "?";
				return _var.DisplayName;
			}
		}
		[Browsable(false)]
		[ReadOnly(true)]
		public LocalVariable ActionOwner
		{
			get
			{
				checkVariable();
		...
		public ParameterValue InstanceType
		{
			get
			{
				if (_valType == null)
				{
					...
					_valType.ParameterID = ActionAssignInstance.IntanceTypeId;
		...
		public ParameterValue InstanceValue
		{
			get
			{
				if (_val == null)
				{
					...
					_val.ParameterID = ActionAssignInstance.IntanceValueId;
