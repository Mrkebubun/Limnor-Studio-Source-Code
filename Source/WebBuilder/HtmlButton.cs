...
{
	[ToolboxBitmapAttribute(typeof(HtmlButton), "Resources.button.bmp")]
	[Description("This is a button on a web page.")]
	public class HtmlButton : Button, IWebClientControl, ICustomTypeDescriptor, INewObjectInit, IWebClientInitializer
	{
		...
		/// <param name="handler">handler method ID</param>
		...
		[Description("Occurs when a key is released over the page")]
		[WebClientMember]
		...
		{
			this.BackColor = System.Windows.Forms.Button.DefaultBackColor;
		}
