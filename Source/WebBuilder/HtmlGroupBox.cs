...
{
	[ToolboxBitmapAttribute(typeof(HtmlGroupBox), "Resources.groupbox.bmp")]
	[Description("This is a group box on a web page.")]
	public class HtmlGroupBox : GroupBox, IWebClientControl, ICustomTypeDescriptor, IDataBindingNameMapHolder
	{
		...
		[Browsable(false)]
		public string ElementName { get { return "fieldset"; } }
