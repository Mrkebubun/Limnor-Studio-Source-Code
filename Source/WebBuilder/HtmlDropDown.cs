...
{
	[ToolboxBitmapAttribute(typeof(HtmlDropDown), "Resources.dropdown.bmp")]
	[Description("This is a drop-down list on a web page.")]
	public class HtmlDropDown : ComboBox, IWebClientControl, ICustomTypeDescriptor
	{
		...
		protected virtual bool IsDropDown { get { return false; } }
		#endregion
