...
{
	[ToolboxBitmapAttribute(typeof(HtmlRadioButton), "Resources.radiobutton.bmp")]
	[Description("This is a radio button on a web page.")]
	public class HtmlRadioButton : RadioButton, IWebClientControl, ICustomTypeDescriptor,ICustomSize
	{
