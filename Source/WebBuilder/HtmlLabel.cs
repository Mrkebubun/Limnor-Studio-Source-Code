...
{
	[ToolboxBitmapAttribute(typeof(HtmlLabel), "Resources.label.bmp")]
	[Description("This is a text on a web page.")]
	public class HtmlLabel : Label, IWebClientControl, ICustomTypeDescriptor, IDataBindingNameMapHolder, ICustomSize, IWebBox
	{
		#region fields and constructors
		private static StringCollection _propertyNames;
		private List<WebResourceFile> _resourceFiles;
		private EnumInlineFloat _float = EnumInlineFloat.none;
		public HtmlLabel()
		{
			Text = "Label";
			_resourceFiles = new List<WebResourceFile>();
			this.AutoSize = true;
			this.Float = EnumInlineFloat.none;
		...
		[Description("Gets a value specifying whether or not the element should float. Absolutely positioned elements ignores the float property. Therefore this property only works when the element is contained in another element, not directly on the page.")]
		[WebClientMember]
		public EnumInlineFloat Float
		{
			get
			{
				return _float;
			...
			{
				_float = value;
				this.AutoSize = (_float == EnumInlineFloat.none);
			}
		}
		#endregion
