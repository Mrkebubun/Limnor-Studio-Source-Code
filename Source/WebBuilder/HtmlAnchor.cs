...
{
	[ToolboxBitmapAttribute(typeof(HtmlAnchor), "Resources.anchor.bmp")]
	[Description("This is a text on a web page.")]
	public class HtmlAnchor : Label, IWebClientControl, ICustomTypeDescriptor, IDataBindingNameMapHolder, ICustomSize
	{
		...
		static HtmlAnchor()
		{
			...
			_propertyNames.Add("href");
			_propertyNames.Add("target");
		...
		[WebClientMember]
		[Description("Specifies where to open the linked document. You may use a frame name or predefined names _blank, _parent, _self, _top")]
