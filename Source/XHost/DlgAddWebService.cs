...
namespace XHost
{
    public partial class DlgAddWebService : Form
    {
        ...
        private LimnorXmlPane2 _designPane;
        ...
        //public LimnorXmlPane DesignPane { get; set; }
        ...
        private bool processWsdl()
        {
            ...
            //string ns = DesignPane.Loader.GetRootId().Namespace;
            //if (string.IsNullOrEmpty(ns))
            //{
            //    ns = DesignPane.Loader.Namespace;
            //}
