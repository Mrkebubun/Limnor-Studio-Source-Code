...
namespace XHost
{
	...
	/// </summary>
    public class HostControl2 : UserControl//, IXHostControl
	{
		/// <summary>
		...
		public HostControl2(HostSurface hostSurface)
		{
                ...
                if (!(DesignerHost.RootComponent is Control) && !(DesignerHost.RootComponent is NewComponentPrompt))
                {
                    if (control.Controls.Count > 0)
                    {
                        if (control.Controls[0] != null)
                        {
                            ...
                            //control.Controls[0].MouseEnter += new EventHandler(HostControl_MouseEnter);
                        }
                    }
                }
			}
        ...
        //public bool SelectComponent(object v, EventHandler h)
        //{
        //    if (_hostSurface != null)
        //    {
        //        return _hostSurface.SelectComponent(v);
        ...
        //    if (_hostSurface != null)
        //    {
        //        IXLoader xl = _hostSurface.Loader as IXLoader;
        //        if (xl != null)
        //        {
        //            xl.SetChanged();
        //        }
        ...
        //    }
        //}
        //public IXLoader XLoader 
        //{
        //    get
        //    {
        //        if (_hostSurface != null)
        //        {
        //            return _hostSurface.Loader as IXLoader;
        //        }
        //        return null;
        //    }
        //}
