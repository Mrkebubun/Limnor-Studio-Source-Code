...
namespace DirectShowLib
{
    ...
    static public class DsToString
    {
        ...
        public static string MediaSubTypeToString(Guid guid)
        {
            ...
            if (s.Length == 36 && string.Compare( s.Substring(8), "-0000-0010-8000-00AA00389B71", StringComparison.OrdinalIgnoreCase) == 0)
            {
    ...
    public class DsROT
    {
        public static bool AddGraphToRot(object graph, out int cookie)
        {
            ...
            try
            {
                ...
                cookie = rot.Register(ROTFLAGS_REGISTRATIONKEEPSALIVE, graph, mk);//, out cookie);
                return true;
            }
            catch (Exception)
            {
