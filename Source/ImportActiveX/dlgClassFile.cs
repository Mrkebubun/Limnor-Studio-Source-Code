...
namespace PerformerImport
{
	...
	/// </summary>
	public class dlgClassFileAx : System.Windows.Forms.Form
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(dlgClassFileAx));
		...
		public bool refreshInfo()
		{
			...
			txtFile.Text = ActiveXImporter.ActiveXInfo.DotNetDLL;
			btFile.Enabled = false;
			if (ActiveXImporter.ActiveXInfo.DotNetDLLReady)
			{
				label1.ForeColor = System.Drawing.Color.Black;
				label2.ForeColor = System.Drawing.Color.Blue;
				chkControlOnly.Checked = ActiveXImporter.ActiveXInfo.ControlOnly;
				if (ActiveXImporter.ActiveXInfo.ShowPublicTypes(listBox1, out sMsg))
				{
					...
					if (listBox1.Items.Count > 0)
					{
						...
						for (int i = 0; i < listBox1.Items.Count; i++)
						{
							...
							if (tp.Equals(ActiveXImporter.ActiveXInfo.DotNetType))
							{
						...
						if (listBox1.SelectedIndex < 0)
						{
							...
							ActiveXImporter.ActiveXInfo.DotNetType = listBox1.Items[0] as System.Type;
						}
					}
					bRet = true;
				}
		...
		{
			if (chkControlOnly.Checked != ActiveXImporter.ActiveXInfo.ControlOnly)
			{
				ActiveXImporter.ActiveXInfo.ControlOnly = chkControlOnly.Checked;
				refreshInfo();
			}
		}
		...
		private void listBox1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			if (n >= 0)
			{
				ActiveXImporter.ActiveXInfo.DotNetType = listBox1.Items[n] as System.Type;
				btNext.Enabled = true;
			}
		}
		...
		private void btFile_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				dlg.FileName = ActiveXImporter.ActiveXInfo.DotNetDLL;
			}
			catch
			{
			}
			...
			{
				ActiveXImporter.ActiveXInfo.SetDotNetDLL(dlg.FileName);
				refreshInfo();
			}
		}
		...
		private void btNext_Click(object sender, System.EventArgs e)
		{
			if (listBox1.SelectedItems.Count > 0)
			{
				for (int i = 0; i < listBox1.SelectedItems.Count; i++)
				{
					...
					if (t != null)
					{
						ActiveXImporter.ActiveXInfo.AddSelectedType(t);
					}
				}
